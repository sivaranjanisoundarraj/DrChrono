...
class ScheduleAppointmentsEventlocators(object):
    ...
    BTN_DURATION  = (By.XPATH, "//*[@class='controls']/following::input[@name='appt-scheduled_time_0']")
    ...
    BTN_NXT = (By.XPATH, "//div[@class='ui-datepicker-title']/following::span[contains(text(),'Next')]")
...
class CalnderLocators(object):
    ...
    BTN_PRE_MONTH = (By.XPATH, "//span[@class='ui-icon ui-icon-circle-triangle-w'][contains(text(),'Prev')]")
